...
import { HOME_PAGE, SECRETARY_PAGE, ADSU_PAGE, CANTEEN_PAGE, FACEBOOK_PAGE } from '../pages';
...
export class TabsPage {
  ...
  protected facebookTab: any = FACEBOOK_PAGE;
  ...
  public toggle(): void {
    // In IOS the searchbar is animated
